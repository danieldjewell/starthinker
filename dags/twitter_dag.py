...
RECIPE = {
    ...
    'tasks': [{
        'dataset': {
            'description':
                'Create a dataset where data will be combined and transfored for upload.',
            'auth': {
                'field': {
                    'name': 'auth_write',
                    'kind': 'authentication',
        ...
        'lineitem': {
            'description':
                'Read current lineitem settings from DV360 into BigQuery, so it can be joined with Twitter analysis.',
            'auth': {
                'field': {
                    'name': 'auth_read',
                    'kind': 'authentication',
        ...
        'bigquery': {
            'description':
                'Get all triggered lineitmes from sheet, if they have a keyword match in twitter, take the triger values, else take the default values (default>trigger).  Take all non-null values from trigger and overlay over current DV360 values. Will be used to upload to DV360.',
            'auth': {
                'field': {
                    'name': 'auth_write',
                    'kind': 'authentication',
        ...
        'lineitem': {
            'description':
                'Write lineitem settings to DV360 after transformation.',
            'auth': {
                'field': {
                    'name': 'auth_read',
                    'kind': 'authentication',
