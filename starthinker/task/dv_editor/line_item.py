    ...
    for row in rows:
        ...
        if row['Action'] == "DELETE":
            ...
            if row['Partner_Revenue_Model'] != row['Partner_Revenue_Model_Edit']:
                ...
                line_item["partnerRevenueModel"]["markupType"] = row[
                    'Partner_Revenue_Model_Edit']
            ...
            if row['Conversion_Percent'] != row['Conversion_Percent_Edit']:
                ...
                line_item["conversionCounting"][
                    "postViewCountPercentageMillis"] = int(
                        float(row['Conversion_Percent_Edit']) * 1000)

            if row['Targeting_Expansion_Level'] != row[
                    'Targeting_Expansion_Level_Edit']:
                line_item.setdefault("targetingExpansion", {})
                line_item["targetingExpansion"][
                    "targetingExpansionLevel"] = row[
                        'Targeting_Expansion_Level_Edit']

            if row['Exclude_1P'] != row['Exclude_1P_Edit']:
                line_item.setdefault("targetingExpansion", {})
                line_item["targetingExpansion"][
                    "excludeFirstPartyAudience"] = row['Exclude_1P_Edit']
