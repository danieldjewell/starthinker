...
def run_cm_queries(project):
    ...
    run_query_from_file(Queries.cm_floodlight_multichart,
                        CM_FLOODLIGHT_MULTICHART_TABLE)
...
def run_dv_360_queries(project):
    ...
    run_query_from_file(Queries.safari_distribution_90days,
                        SAFARI_DISTRIBUTION_90DAYS_TABLE)
...
def create_cm_site_segmentation(project):
    ...
    run_query_from_file(Queries.cm_site_segmentation,
                        CM_SITE_SEGMENTATION_TABLE)
